...
@app.on_message(filters.command(["gban", "globalban","حظر عام"], "") & SUDOERS)
@language
...
@app.on_message(filters.command(["ungban","الغاء حظر عام"], "") & SUDOERS)
@language
...
@app.on_message(filters.command(["gbannedusers", "gbanlist","المحظورين عام"], "") & SUDOERS)
@language
